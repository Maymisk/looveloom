      ...
      <div className="flex flex-col gap-3">
        <BlurFade delay={0.3}>
          <h2 className="w-full text-7xl max-xl:text-5xl text-center drop-shadow-md">
            <span className="font-bold text-red-500">Eternalize</span> your love
            with <span className="font-bold text-red-500">few clicks</span>
          </h2>
        </BlurFade>
        ...
        <BlurFade className="flex flex-col gap-4" delay={0.5}>
          <p className="w-full text-gray700 text-center font-light italic text-lg max-xl:text-base">
            ...
            aliquam facere quam in quae aperiam voluptatum, ipsam iste
            cupiditate! Voluptatem, cupiditate! Ullam aliquid dolore quas
            tempore obcaecati eveniet dolores laborum.
          </p>

          <p className="w-full text-gray700 text-center font-light italic text-lg max-xl:text-base">
            Create a personalized website and QR code to share your love story
            with the world and surprise your special someone in a unique way!
          </p>
        </BlurFade>
      </div>
