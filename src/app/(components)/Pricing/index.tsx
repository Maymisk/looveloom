  ...
  return (
    <section className="flex max-xl:flex-col items-center justify-center gap-6 max-xl:gap-12">
      ...
      <div className="relative w-full max-w-[400px]">
        <div className="w-max absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black text-xl text-center font-bold capitalize rounded-full px-4 py-1">
          <span className="text-red-500">Best deal</span>
        </div>
