...
export function PricingCard({
	...
	return (
		<div className="w-full h-full max-w-[400px] flex flex-col gap-8 p-8 bg-gray-500 rounded-lg shadow-md shadow-gray-800">
			...
			<Link
				href={''}
				className="w-full px-8 py-4 border-2 border-red-300 text-red-300 font-bold hover:text-red-500 hover:border-red-500 transition-all rounded-md text-center mt-auto"
			>
				Buy
			</Link>
		</div>
